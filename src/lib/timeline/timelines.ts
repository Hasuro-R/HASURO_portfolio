...
export const timelines = <timelineType[]>[
    {id: 30, title: 'ReactSlideCraft', feature: {url: 'https://github.com/Hasuro-R/react-slide-craft', description: 'Reactで簡単にスライドを作れるReactライブラリ', techs: ['react', 'vite']}, year: '2025', date: 'May 26', kind: 'released'},
    {id: 29, title: '42Tokyo', year: '2025', date: 'Apr ~', kind: 'other'},
    {id: 28, title: 'note株式会社', feature: {url: '', description: 'エンジニアの長期インターン', techs: ['rails', 'next', 'nuxt', 'svelte']}, year: '2025', date: 'Apr ~', kind: 'internship'},
