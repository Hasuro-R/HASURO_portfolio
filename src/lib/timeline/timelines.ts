...
export const timelines = <timelineType[]>[
    ...
    {id: 22, title: '株式会社イロリ', feature: {url: 'https://iroriworks.com/', description: 'モバイルエンジニアの長期インターン', techs: ['flutter']}, year: '2024', date: 'Jun ~ Jan 2024-25', kind: 'internship'},
    {id: 21, title: 'CA Tech Lounge入会', year: '2024', date: 'Jun ~ now', kind: 'other'},
